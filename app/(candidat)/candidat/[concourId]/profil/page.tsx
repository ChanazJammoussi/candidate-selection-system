...
// ── Données Tunisie : 24 gouvernorats → délégations (ville, codePostal) ──
            ...
            <CardContent>
              <FieldGroup>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {/* Gouvernorat */}
                  <Field>
                    <FieldLabel htmlFor="gouvernorat">Gouvernorat</FieldLabel>
                    <Select
                  ...
                  {/* Ville — dynamique selon le gouvernorat */}
                  <Field>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {/* Code postal — pré-rempli, modifiable */}
                  <Field>
                  ...
                  {/* Adresse complète */}
                  <Field>
                    <FieldLabel htmlFor="adresse">Adresse complète</FieldLabel>
                    <div className="relative">
